...
export const Table: FC<ITable> = ({
  ...
  return (
    <Fragment>
      <div className={classNames("border  overflow-auto rounded-lg shadow-sm mt-3")}>
        <div
            className="flex items-center justify-between flex-column flex-wrap md:flex-row space-y-4 md:space-y-0 pb-4 bg-white dark:bg-gray-900 p-4">
        ...
        <table className="overflow-auto min-w-full">
          ...
          <tbody
            className={classNames("bg-white w-full divide-y ")}
          >
            <tr>
              ...
              {loadingData && (
                <td colSpan={8} className=" bg-white bg-opacity-70 p-6 w-full h-full ">
                  <div role="status">
                    <svg
                      aria-hidden="true"
